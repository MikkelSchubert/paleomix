...
@pytest.mark.parametrize(("src", "dst"), tuple(zip(_REF_SRC, _REF_DST, strict=True)))
...
_IUB_DST = "ACGTMRWSYKVHDBN"


@pytest.mark.parametrize(("src", "dst"), tuple(zip(_IUB_SRC, _IUB_DST, strict=True)))
